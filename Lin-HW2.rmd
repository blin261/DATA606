...
X <- c(0, 1, 2)
"P(X)" <- c(0.54, 0.34, 0.12)
"XP(X)" <- c(0*0.54, 1*0.34, 2*0.12)
"(X-E(X))^2" <- c((0-0.58)^2, (1-0.58)^2, (2-0.58)^2)

"P(X)(X-E(X)^2)" <- c(0.54 * (0-0.58)^2, 0.34*(1-0.58)^2, 0.12* (2-0.58)^2)
df <- data.frame(X, "P(X)", "XP(X)", "(X-E(X))^2", "P(X)(X-E(X)^2)")
df

0.54 * (0-0.58)^2 + 0.34*(1-0.58)^2 + 0.12*(2-0.58)^2
```
